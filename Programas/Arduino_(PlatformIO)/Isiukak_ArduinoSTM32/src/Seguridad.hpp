...
uint8_t Joystick_X_EstaEnRango();
uint8_t Joystick_Y_EstaEnRango();
...
uint8_t Actuador_Acelerador_EstaEnRango();
uint8_t Actuador_Freno_EstaEnRango();
...
uint8_t Potenciometros_EstanEnRango(const int joystick_X, const int joystick_Y,
                                    const int actuadorAcelerador_Posicion, const int actuadorFreno_Posicion,
                                    uint8_t &joystickX_EnRango, uint8_t &joystickY_EnRango, uint8_t &joystick_EnRango,
                                    uint8_t &actuadorAcelerador_EnRango, uint8_t &actuadorFreno_EnRango, uint8_t &actuadores_EnRango )
{
...
/*! Aplicar las medidas de seguridad en función del error.  */
    ...
    if(!Joystick_X_Conectado)
    {
        ...
        {
            Serial.println("**Joystick_X_Desconectado**");
    ...
    if(!Joystick_Y_Conectado)
    {
        ...
        {
            Serial.println("**Joystick_Y_Desconectado**");
    ...
    if(!ActuadorAcelerador_Conectado)
    {
        ...
        {
            Serial.println("**Acelerador_Desconectado**");
    ...
    if(!ActuadorFreno_Conectado)
    {
        ...
        {
            Serial.println("**Freno_Desconectado**");
    ...
    if(!Joystick_X_EnRango)
    {
        ...
        {
            Serial.println("**Joystick_X_OutOfRange**");
    ...
    if(!Joystick_Y_EnRango)
    {
        ...
        {
            Serial.println("**Joystick_Y_OutOfRange**");
    ...
    if(!ActuadorAcelerador_EnRango)
    {
        ...
        {
            Serial.println("**Acelerador_OutOfRange**");
    ...
    if(!ActuadorFreno_EnRango)
    {
        ...
        {
            Serial.println("**Freno_OutOfRange**");
