//******************************************************
//Instrucciones y variables para el control del volante
//******************************************************
...
int ControlPosicionVolante(float posicionMotorDeseada, float posicionMotorActual, float* errorMotorDireccion)
{
  float KP=15;
  float KD=0.1;
  float KI = 0.3;
  ...
  *errorMotorDireccion = posicionMotorDeseada - posicionMotorActual;
  
  int controlMotorDireccion = -((*errorMotorDireccion) * (KP));
