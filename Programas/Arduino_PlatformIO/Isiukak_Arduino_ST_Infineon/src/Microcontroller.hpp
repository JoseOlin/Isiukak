...
#define pinD0 0    // PA_3     Serial RX
#define pinD1 1    // PA_2     Serial TX
#define pinD2 2    // PA_10    smcSerial RX
#define pinD3 3    // PB3      pinVDDVirtual
#define pinD4 4    // PB5      pinOutput_PalancaBajar
#define pinD5 5    // PB4      pinOutput_PalancaSubir
#define pinD6 6
#define pinD7 7    // PA8      pinGNDVirtual
#define pinD8 8    // PA9      smcSerial TX
#define pinD9 9    // PC7      pinBotonParoEmergencia
#define pinD10 10  // PB6      pinFijarPosicionFreno
#define pinD11 11  // PA7      pinBajarPalanca
#define pinD12 12  // PA6      pinAGND
#define pinD13 13  // PA5      pinAVDD
...
int pinGNDVirtual = pinD7; /// TODO: C. Cambiar pinD7 en XMC es INPUT only
int pinVDDVirtual = pinD3; //
int pinAVDD = pinD13; ////!! WARNING: Only INPUT en Infineon.  Verificar si es necesario en el Infineon XMC
int pinAGND = pinD12; ////!! WARNING: Only INPUT en Infineon.  Verificar si es necesario en el Infineon XMC

int pinBotonParoEmergencia = pinD9; /// TODO: C. ADC Considerar cambiar

int pinFijarPosicionFreno = pinD10; /// TODO: C. ADC Considerar cambiar
int pinBajarPalanca = pinD11;      /// TODO: C. ADC Considerar cambiar
