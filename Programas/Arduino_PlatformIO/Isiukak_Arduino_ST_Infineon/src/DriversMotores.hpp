...
uint8_t setMotorSpeed_Protocol(int address, int speed)  // Function for sending data to motor controller
{
    uint8_t writeStatus;
  if(speed < -3200){
      speed = -3200; }
