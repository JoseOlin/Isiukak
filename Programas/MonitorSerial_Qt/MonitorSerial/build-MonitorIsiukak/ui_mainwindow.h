...
public:
    ...
    QGroupBox *JoystickValues_gBox_verLay;
    ...
    QGroupBox *AcceleratorValues_verLay;
    QVBoxLayout *verticalLayout_4;
    QFrame *Accel_FeedbackValues_form;
    ...
    QFormLayout *Accel_DriverValues_lay;
    QLabel *label_9;
    ...
    QGroupBox *Volante_gBox_verLay;
    QVBoxLayout *verticalLayout_5;
    QCheckBox *volante_Activado_chk;
    QCheckBox *volante_Inhibido_chk;
    QComboBox *VolanteModo_cmb;
    QVBoxLayout *VolanteCtrlValue_verLay;
    QLabel *VolanteControlValue_lbl;
    ...
    QWidget *ShiftGear_and_SystemInfo_Qwid_verLay;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        JoystickValues_gBox_verLay = new QGroupBox(Joystick_and_Actuators_hotLayout);
        JoystickValues_gBox_verLay->setObjectName(QString::fromUtf8("JoystickValues_gBox_verLay"));
        sizePolicy.setHeightForWidth(JoystickValues_gBox_verLay->sizePolicy().hasHeightForWidth());
        JoystickValues_gBox_verLay->setSizePolicy(sizePolicy);
        JoystickValues_gBox_verLay->setMinimumSize(QSize(140, 0));
        JoystickValues_gBox_verLay->setMaximumSize(QSize(160, 525));
        JoystickValues_gBox_verLay->setLayoutDirection(Qt::LeftToRight);
        verticalLayout_6 = new QVBoxLayout(JoystickValues_gBox_verLay);
        verticalLayout_6->setSpacing(6);
        verticalLayout_6->setContentsMargins(11, 11, 11, 11);
        verticalLayout_6->setObjectName(QString::fromUtf8("verticalLayout_6"));
        verticalLayout_6->setContentsMargins(-1, 1, -1, 1);
        joystick_Activado_chk = new QCheckBox(JoystickValues_gBox_verLay);
        ...
        chk_LED_Joy_Y_Desc = new QCheckBox(JoystickValues_gBox_verLay);
        ...
        chk_LED_Joy_X_Desc = new QCheckBox(JoystickValues_gBox_verLay);
        ...
        chk_LED_Joy_Y_OutR = new QCheckBox(JoystickValues_gBox_verLay);
        ...
        chk_LED_Joy_X_OutR = new QCheckBox(JoystickValues_gBox_verLay);
        ...
        joystick_Y_lbl = new QLabel(JoystickValues_gBox_verLay);
        ...
        joystick_Y_lcd = new QLCDNumber(JoystickValues_gBox_verLay);
        ...
        joystick_X_lbl = new QLabel(JoystickValues_gBox_verLay);
        ...
        joystick_X_lcd = new QLCDNumber(JoystickValues_gBox_verLay);
        ...
        label_39 = new QLabel(JoystickValues_gBox_verLay);
        label_39->setObjectName(QString::fromUtf8("label_39"));

        formLayout_2->setWidget(5, QFormLayout::LabelRole, label_39);

        label_40 = new QLabel(JoystickValues_gBox_verLay);
        ...
        gridLayout_3 = new QFrame(JoystickValues_gBox_verLay);
        ...
        FixFreno_chk = new QCheckBox(Buttons_gBox_verLay);
        ...
        verticalLayout_9->addWidget(FixFreno_chk);

        PalUp_chk = new QCheckBox(Buttons_gBox_verLay);
        ...
        verticalLayout_9->addWidget(PalUp_chk);

        PalDown_chk = new QCheckBox(Buttons_gBox_verLay);
        ...
        verticalLayout_9->addWidget(PalDown_chk);

        RoadMode_chk = new QCheckBox(Buttons_gBox_verLay);
        ...
        sizePolicy.setHeightForWidth(BrakeValues_gBox_verLay->sizePolicy().hasHeightForWidth());
        BrakeValues_gBox_verLay->setSizePolicy(sizePolicy);
        BrakeValues_gBox_verLay->setMinimumSize(QSize(170, 450));
        BrakeValues_gBox_verLay->setMaximumSize(QSize(180, 525));
        BrakeValues_gBox_verLay->setAutoFillBackground(true);
        verticalLayout_2 = new QVBoxLayout(BrakeValues_gBox_verLay);
        verticalLayout_2->setSpacing(3);
        verticalLayout_2->setContentsMargins(11, 11, 11, 11);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(3, 1, 5, 1);
        frame_5 = new QFrame(BrakeValues_gBox_verLay);
        ...
        frmLay_Freno->setContentsMargins(-1, 3, -1, 3);
        ...
        FrenoControl_Slider = new QSlider(BrakeValues_gBox_verLay);
        ...
        frame_2 = new QFrame(BrakeValues_gBox_verLay);
        ...
        Brake_Driver_lay_2 = new QFrame(BrakeValues_gBox_verLay);
        ...
        SensorsInfo_horLayout->addWidget(BrakeValues_gBox_verLay);

        AcceleratorValues_verLay = new QGroupBox(Joystick_and_Actuators_hotLayout);
        AcceleratorValues_verLay->setObjectName(QString::fromUtf8("AcceleratorValues_verLay"));
        sizePolicy.setHeightForWidth(AcceleratorValues_verLay->sizePolicy().hasHeightForWidth());
        AcceleratorValues_verLay->setSizePolicy(sizePolicy);
        AcceleratorValues_verLay->setMinimumSize(QSize(170, 450));
        AcceleratorValues_verLay->setMaximumSize(QSize(180, 525));
        AcceleratorValues_verLay->setAutoFillBackground(true);
        AcceleratorValues_verLay->setFlat(false);
        verticalLayout_4 = new QVBoxLayout(AcceleratorValues_verLay);
        verticalLayout_4->setSpacing(3);
        verticalLayout_4->setContentsMargins(11, 11, 11, 11);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        verticalLayout_4->setContentsMargins(3, 1, 3, 1);
        Accel_FeedbackValues_form = new QFrame(AcceleratorValues_verLay);
        Accel_FeedbackValues_form->setObjectName(QString::fromUtf8("Accel_FeedbackValues_form"));
        Accel_FeedbackValues_form->setMinimumSize(QSize(136, 0));
        frmLay_Acelerador = new QFormLayout(Accel_FeedbackValues_form);
        ...
        frmLay_Acelerador->setContentsMargins(-1, 3, -1, 3);
        Acel_Activado_lbl = new QLabel(Accel_FeedbackValues_form);
        ...
        Acel_Activado_chk = new QCheckBox(Accel_FeedbackValues_form);
        ...
        Acel_Inhibido_lbl = new QLabel(Accel_FeedbackValues_form);
        ...
        Acel_Inhibido_chk = new QCheckBox(Accel_FeedbackValues_form);
        ...
        chk_LED_Acel_OutR = new QCheckBox(Accel_FeedbackValues_form);
        ...
        valorAcelerador_lbl = new QLabel(Accel_FeedbackValues_form);
        ...
        aceleradorPos_lcd = new QLCDNumber(Accel_FeedbackValues_form);
        ...
        label_3 = new QLabel(Accel_FeedbackValues_form);
        label_3->setObjectName(QString::fromUtf8("label_3"));

        frmLay_Acelerador->setWidget(6, QFormLayout::LabelRole, label_3);

        aceleradorDes_lcd = new QLCDNumber(Accel_FeedbackValues_form);
        ...
        label_5 = new QLabel(Accel_FeedbackValues_form);
        label_5->setObjectName(QString::fromUtf8("label_5"));

        frmLay_Acelerador->setWidget(7, QFormLayout::LabelRole, label_5);

        Acelerador_lcdError = new QLCDNumber(Accel_FeedbackValues_form);
        ...
        label_4 = new QLabel(Accel_FeedbackValues_form);
        label_4->setObjectName(QString::fromUtf8("label_4"));

        frmLay_Acelerador->setWidget(8, QFormLayout::LabelRole, label_4);

        aceleradorControl_lcd = new QLCDNumber(Accel_FeedbackValues_form);
        ...
        chk_LED_Acel_Desc = new QCheckBox(Accel_FeedbackValues_form);
        ...
        verticalLayout_4->addWidget(Accel_FeedbackValues_form);

        AceleradorControl_Slider = new QSlider(AcceleratorValues_verLay);
        ...
        Accel_PosLimits_verLay = new QFrame(AcceleratorValues_verLay);
        Accel_PosLimits_verLay->setObjectName(QString::fromUtf8("Accel_PosLimits_verLay"));
        Accel_PosLimits_verLay->setLayoutDirection(Qt::LeftToRight);
        Accel_PosLimits_verLay->setFrameShape(QFrame::StyledPanel);
        Accel_PosLimits_verLay->setFrameShadow(QFrame::Raised);
        verticalLayout_13 = new QVBoxLayout(Accel_PosLimits_verLay);
        verticalLayout_13->setSpacing(2);
        verticalLayout_13->setContentsMargins(11, 11, 11, 11);
        verticalLayout_13->setObjectName(QString::fromUtf8("verticalLayout_13"));
        verticalLayout_13->setContentsMargins(3, 2, 3, 1);
        label_30 = new QLabel(Accel_PosLimits_verLay);
        ...
        label_31 = new QLabel(Accel_PosLimits_verLay);
        label_31->setObjectName(QString::fromUtf8("label_31"));

        formLayout_4->setWidget(0, QFormLayout::LabelRole, label_31);

        label_32 = new QLabel(Accel_PosLimits_verLay);
        ...
        Accel_PosLimits_Max_lbl = new QLabel(Accel_PosLimits_verLay);
        ...
        Accel_PosLimits_Min_lbl = new QLabel(Accel_PosLimits_verLay);
        ...
        verticalLayout_4->addWidget(Accel_PosLimits_verLay);

        Accel_DriverValues_lay = new QFormLayout();
        Accel_DriverValues_lay->setSpacing(6);
        Accel_DriverValues_lay->setObjectName(QString::fromUtf8("Accel_DriverValues_lay"));
        Accel_DriverValues_lay->setVerticalSpacing(6);
        Accel_DriverValues_lay->setContentsMargins(-1, 3, -1, 3);
        label_9 = new QLabel(AcceleratorValues_verLay);
        label_9->setObjectName(QString::fromUtf8("label_9"));

        Accel_DriverValues_lay->setWidget(0, QFormLayout::LabelRole, label_9);

        Accel_Vin_lbl = new QLabel(AcceleratorValues_verLay);
        Accel_Vin_lbl->setObjectName(QString::fromUtf8("Accel_Vin_lbl"));
        Accel_Vin_lbl->setFont(font2);

        Accel_DriverValues_lay->setWidget(0, QFormLayout::FieldRole, Accel_Vin_lbl);

        Accel_Temp_lbl = new QLabel(AcceleratorValues_verLay);
        Accel_Temp_lbl->setObjectName(QString::fromUtf8("Accel_Temp_lbl"));
        Accel_Temp_lbl->setFont(font2);

        Accel_DriverValues_lay->setWidget(1, QFormLayout::FieldRole, Accel_Temp_lbl);

        label_14 = new QLabel(AcceleratorValues_verLay);
        label_14->setObjectName(QString::fromUtf8("label_14"));

        Accel_DriverValues_lay->setWidget(1, QFormLayout::LabelRole, label_14);

        label_11 = new QLabel(AcceleratorValues_verLay);
        label_11->setObjectName(QString::fromUtf8("label_11"));

        Accel_DriverValues_lay->setWidget(2, QFormLayout::LabelRole, label_11);

        Accel_Error_lbl = new QLabel(AcceleratorValues_verLay);
        Accel_Error_lbl->setObjectName(QString::fromUtf8("Accel_Error_lbl"));

        Accel_DriverValues_lay->setWidget(2, QFormLayout::FieldRole, Accel_Error_lbl);

        accel_ShowInfo_rBtn = new QRadioButton(AcceleratorValues_verLay);
        ...
        Accel_DriverValues_lay->setWidget(3, QFormLayout::FieldRole, accel_ShowInfo_rBtn);


        verticalLayout_4->addLayout(Accel_DriverValues_lay);


        SensorsInfo_horLayout->addWidget(AcceleratorValues_verLay);

        Volante_gBox_verLay = new QGroupBox(Joystick_and_Actuators_hotLayout);
        Volante_gBox_verLay->setObjectName(QString::fromUtf8("Volante_gBox_verLay"));
        sizePolicy.setHeightForWidth(Volante_gBox_verLay->sizePolicy().hasHeightForWidth());
        Volante_gBox_verLay->setSizePolicy(sizePolicy);
        Volante_gBox_verLay->setMinimumSize(QSize(110, 450));
        Volante_gBox_verLay->setMaximumSize(QSize(110, 525));
        Volante_gBox_verLay->setAutoFillBackground(true);
        verticalLayout_5 = new QVBoxLayout(Volante_gBox_verLay);
        verticalLayout_5->setSpacing(4);
        verticalLayout_5->setContentsMargins(11, 11, 11, 11);
        verticalLayout_5->setObjectName(QString::fromUtf8("verticalLayout_5"));
        verticalLayout_5->setContentsMargins(3, 3, 3, 3);
        volante_Activado_chk = new QCheckBox(Volante_gBox_verLay);
        ...
        volante_Inhibido_chk = new QCheckBox(Volante_gBox_verLay);
        ...
        VolanteModo_cmb = new QComboBox(Volante_gBox_verLay);
        ...
        VolanteCtrlValue_verLay = new QVBoxLayout();
        VolanteCtrlValue_verLay->setSpacing(3);
        VolanteCtrlValue_verLay->setObjectName(QString::fromUtf8("VolanteCtrlValue_verLay"));
        VolanteControlValue_lbl = new QLabel(Volante_gBox_verLay);
        VolanteControlValue_lbl->setObjectName(QString::fromUtf8("VolanteControlValue_lbl"));
        VolanteControlValue_lbl->setMinimumSize(QSize(25, 0));
        VolanteControlValue_lbl->setAlignment(Qt::AlignCenter);

        VolanteCtrlValue_verLay->addWidget(VolanteControlValue_lbl);

        volante_lcd = new QLCDNumber(Volante_gBox_verLay);
        ...
        VolanteCtrlValue_verLay->addWidget(volante_lcd);


        verticalLayout_5->addLayout(VolanteCtrlValue_verLay);

        VolanteControl_Dial = new QDial(Volante_gBox_verLay);
        ...
        Steer_Temp_lbl = new QLabel(Volante_gBox_verLay);
        ...
        Steer_Error_lbl = new QLabel(Volante_gBox_verLay);
        ...
        steer_ShowInfo_rBtn = new QRadioButton(Volante_gBox_verLay);
        ...
        SensorsInfo_horLayout->addWidget(Volante_gBox_verLay);

        ShiftGear_and_SystemInfo_Qwid_verLay = new QWidget(Joystick_and_Actuators_hotLayout);
        ShiftGear_and_SystemInfo_Qwid_verLay->setObjectName(QString::fromUtf8("ShiftGear_and_SystemInfo_Qwid_verLay"));
        ShiftGear_and_SystemInfo_Qwid_verLay->setMinimumSize(QSize(56, 450));
        ShiftGear_and_SystemInfo_Qwid_verLay->setMaximumSize(QSize(160, 525));
        shiftGear_and_DefaultDefines = new QVBoxLayout(ShiftGear_and_SystemInfo_Qwid_verLay);
        ...
        palanca_grp = new QGroupBox(ShiftGear_and_SystemInfo_Qwid_verLay);
        ...
        verticalLayout_14->setContentsMargins(-1, 3, 3, 3);
        ...
        time_frame = new QFrame(ShiftGear_and_SystemInfo_Qwid_verLay);
        ...
        SensorsInfo_horLayout->addWidget(ShiftGear_and_SystemInfo_Qwid_verLay);
        ...
        logoOlin_horLay = new QHBoxLayout();
        logoOlin_horLay->setSpacing(6);
        logoOlin_horLay->setObjectName(QString::fromUtf8("logoOlin_horLay"));
        ...
        logoOlin_horLay->addWidget(logoOlin_lbl);


        verticalLayout_12->addLayout(logoOlin_horLay);
        ...
        estadoSistema_lbl->setMinimumSize(QSize(200, 30));
        QFont font4;
        ...
        serialConn_horFrame = new QFrame(Edo_ConexionConfig_and_Error_vertWidget);
        serialConn_horFrame->setObjectName(QString::fromUtf8("serialConn_horFrame"));
        horizontalLayout_4 = new QHBoxLayout(serialConn_horFrame);
        ...
        lblDescripcion = new QLabel(serialConn_horFrame);
        ...
        cmbBaudRate = new QComboBox(serialConn_horFrame);
        cmbBaudRate->setObjectName(QString::fromUtf8("cmbBaudRate"));

        horizontalLayout_2->addWidget(cmbBaudRate);

        cmbSerialPortSelector = new QComboBox(serialConn_horFrame);
        ...
        verticalLayout_12->addWidget(serialConn_horFrame);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Buttons_gBox_verLay->setTitle(QApplication::translate("MainWindow", "Botones", nullptr));
        ...
        AcceleratorValues_verLay->setTitle(QApplication::translate("MainWindow", "Acelerador", nullptr));
        ...
        Volante_gBox_verLay->setTitle(QApplication::translate("MainWindow", "Volante", nullptr));
        ...
        VolanteControlValue_lbl->setText(QApplication::translate("MainWindow", "Ctrl:", nullptr));
